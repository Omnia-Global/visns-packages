...
/**
 * A monitored queue call stopped ringing without being answered here (hung up,
 * missed, or ended elsewhere) — every open pop for it should close.
 */
class CallQueueEnded implements ShouldBroadcastNow
{

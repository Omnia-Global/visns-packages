...
{
    // The post-login hooks, the `previous` filter and the CSRF token read.
    // Shared with PasskeyController, which arrives at an authenticated user by
    // a different route and has to answer in the same envelope.

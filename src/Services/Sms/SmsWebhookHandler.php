...
class SmsWebhookHandler
{
    ...
    /**
     * The message text, with Zoom's escaping undone - see SmsText for what
     * the webhook does to newlines and emoji.
     */
    private function messageText(array $object): string
    {
        return SmsText::unescape((string) (Arr::get($object, 'message') ?? ''));
    }
